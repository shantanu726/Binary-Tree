...
public:
    ...
    void travelsLeft(Node *root, vector<int> &ans)
    {
        ...
        if (root->left)
        {
            travelsLeft(root->left, ans);
        }
        else
        {
            travelsLeft(root->right, ans);
        }
    }

    void travelsLeaf(Node *root, vector<int> &ans)
    {
        if (root == NULL)
        {
            return;
        ...
        travelsLeaf(root->left, ans);
        travelsLeaf(root->right, ans);
    }
